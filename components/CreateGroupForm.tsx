...
export default function CreateGroupForm({
  ...
  const [maxMembersInput, setMaxMembersInput] = useState("0");
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400">
          Set up your rotating savings protocol with DeFi yields
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-gradient-to-br from-gray-500/10 to-gray-600/10 border border-gray-500/20 rounded-xl p-4">
            ...
            <p className="text-2xl font-bold text-gray-300">
              {formData.timeframe === "72h"
                ? "72h"
                : formData.timeframe === "weekly"
                ? "7d"
                : "30d"}
            </p>
        ...
        <div className="bg-crypto-dark-700/30 rounded-xl p-4 border border-crypto-dark-600">
          <div className="text-sm text-gray-300 space-y-2">
            <div className="flex items-center">
              ...
              <span>
                {formData.maxMembers} members × {formData.contributionAmount}{" "}
                USDC each
              </span>
            </div>
            <div className="flex items-center">
            ...
            {formData.biddingEnabled && (
              <div className="flex items-center">
                ...
                <span>
                  Creator kickback: 5% of protocol fees from total bids
                </span>
              </div>
            )}
          </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 mt-10">
        ...
        <div className="h-[58rem] bg-gradient-to-br from-crypto-dark-800/80 to-crypto-dark-900/80 backdrop-blur-sm border border-crypto-dark-700 rounded-2xl p-6 shadow-xl">
            ...
            <div className="flex items-center mb-4 ">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Choose how members get selected for lump sums
                </p>
              </div>
            </div>
            <button
              type="button"
              onClick={() =>
                handleInputChange("biddingEnabled", !formData.biddingEnabled)
              }
          ...
          <div className="bg-crypto-dark-700/30 mb-6 rounded-xl p-4 border border-crypto-dark-600">
            <div className="flex items-start space-x-3">
              <div
                className={`w-2 h-2 rounded-full mt-2 ${
                  formData.biddingEnabled ? "bg-blue-400" : "bg-gray-500"
                }`}
              ></div>
              <div>
