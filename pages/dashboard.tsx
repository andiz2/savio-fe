      ...
      case 'overview':
        return (
          <div className="space-y-8">
            ...
            {/* SAVE Section */}
            <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300">
    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800">
        {ready && authenticated ? (
          <>
            {/* Header */}
            <header className="bg-gradient-to-r from-gray-800/90 to-gray-900/90 backdrop-blur-sm border-b border-gray-700 shadow-xl">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="bg-gradient-to-r from-gray-700 to-gray-800 px-4 py-2 rounded-xl border border-gray-600">
                    ...
                    <button
                      onClick={logout}
                      className="bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 py-2 px-4 rounded-xl text-gray-300 transition-all duration-300 border border-gray-600 hover:border-gray-500 transform hover:scale-105"
                    >
                      <div className="flex items-center space-x-2">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              {/* Navigation Tabs */}
              <div className="mb-8">
                <nav className="bg-gradient-to-r from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-gray-700 rounded-2xl p-2 shadow-xl">
